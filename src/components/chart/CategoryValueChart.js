    ...
    methods: {
        makeChart: function(chartDiv){
            ...
            if(seriesVue === undefined) {
                throw Error('DateValueChart : vue component error : series component not found in child component list !!');
            }

            if(this.seriesSet === undefined) {
                throw Error('CategoryValueChart : vue component error : series-set props not found !!');
            }
        ...
        getTheme: function() {
            switch(this.theme) {                
                case 'dataviz': return am4themes_dataviz === undefined ? null : am4themes_dataviz;
                case 'material': return am4themes_material === undefined ? null : am4themes_material;
                case 'kelly': return am4themes_kelly === undefined ? null : am4themes_kelly;
                case 'dark': return am4themes_dark === undefined ? null : am4themes_dark;
                case 'frozen': return am4themes_frozen === undefined ? null : am4themes_frozen;
                case 'moonrisekingdom': return am4themes_moonrisekingdom === undefined ? null : am4themes_moonrisekingdom;
                case 'spiritedaway': return am4themes_spiritedaway === undefined ? null : am4themes_spiritedaway;
                default: return null;
            }
        }
    },
