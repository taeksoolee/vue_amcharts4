const CategoryValueChart = {
  ...
  methods: {
    makeChart: function (chartDiv) {
      ...
      categoryAxis.dataFields.category = seriesVue.componentInstance.fieldName;
    ...
    getTheme: function () {
      switch (this.theme) {
        case 'dataviz':
          return am4themes_dataviz === undefined ? null : am4themes_dataviz;
        case 'material':
          return am4themes_material === undefined ? null : am4themes_material;
        case 'kelly':
          return am4themes_kelly === undefined ? null : am4themes_kelly;
        case 'dark':
          return am4themes_dark === undefined ? null : am4themes_dark;
        case 'frozen':
          return am4themes_frozen === undefined ? null : am4themes_frozen;
