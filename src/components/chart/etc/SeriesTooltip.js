const SeriesTooltip = {
    ...
    computed: {
        ...
        styleC: function() {
            return this.tooltipStyle === undefined ? 'a' : this.tooltipStyle.toLocaleLowerCase();
        },
    ...
    methods: {
        setTooltip(series, seriesColor, tooltipText, isPropertyFields) {
            ...
            switch(this.styleC) {
                case 'a':
                    this.styleA(series, seriesColor, tooltipText, isPropertyFields);
                    break;
                case 'b':
                    this.styleB(series, seriesColor, tooltipText, isPropertyFields);
                    break;
            }
        ...
        styleB: function(series, seriesColor, tooltipText, isPropertyFields) {
            ...
            if(isPropertyFields) {
                ...
                series.tooltip.background.propertyFields.stroke = am4core.color('#fff');
