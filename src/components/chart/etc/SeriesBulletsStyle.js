const SeriesBulletsStyle = {
    ...
    computed: {
        typeC: function() {
            const type = this.type === undefined ? 'c' : this.type.toLowerCase();
            ...
            switch(type) {
                ...
                default:
                    console.error('BulletsSeriesStyle : vue component error : unknown type props');
            }
        },
        ...
        fillColorC: function() {
            return this.fillColor === undefined ? null : am4core.color(this.fillColor);
        },
        strokeColorC: function() {
            return this.strokeColor === undefined ? am4core.color('#fff') : am4core.color(this.strokeColor);
        },
