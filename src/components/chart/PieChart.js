const PieChart = {
    ...
    mounted: function(){ 
        if(this.valueName === undefined) {
            throw Error('PieChart : vue component error : value-name props not found !!');
        }

        if(this.categoryName === undefined) {
            throw Error('PieChart : vue component error : category-name props not found !!');
        }
    ...
    methods: {
        makeChart: function(chartDiv){
            ...
            const series = createSeries(this.chart, this.valueName, this.categoryName);
